...
public enum ScoreboardLocale implements IDataAccessor {
    ...
    PARTY_IN_GAME("SCOREBOARDS.PARTY.IN-MATCH", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bOpponent: &c<opponent>",
            "&bPing: &a<ping>ms",
            " ",
            "&bserver.net",
            "&7&m--------------------"),

    PARTY_IN_GAME_TEAM("SCOREBOARDS.PARTY.IN-MATCH-TEAM", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bYour Team: &a<alive>&f/&a<max>",
            "&bOpponents: &c<alive-opponent>&f/&c<max-opponent>",
            " ",
    ...
    PARTY_IN_GAME_FFA("SCOREBOARDS.PARTY.IN-MATCH-FFA", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bAlive: &a<alive>",
            "&bPlayers: &f<players>",
            " ",
    ...
    PARTY_IN_GAME_BOXING("SCOREBOARDS.PARTY.BOXING", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bHits: &a<hits>&7/&a<max-hits>",
            "&bOpponent: &c<opponent-hits>&7/&c<max-hits>",
            " ",
            "&bserver.net",
            "&7&m--------------------"),

    PARTY_IN_GAME_BOXING_TEAM("SCOREBOARDS.PARTY.BOXING-TEAM", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bYour Team: &a<alive>&f/&a<max>",
            "&bOpponents: &c<alive-opponent>&f/&c<max-opponent>",
            "&bHits: &a<hits>&7/&a<max-hits>",
    ...
    PARTY_IN_GAME_BOXING_FFA("SCOREBOARDS.PARTY.BOXING-FFA", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bHits: &a<hits>&7/&a<max-hits>",
            "&bAlive: &a<alive>",
            " ",
    ...
    PARTY_IN_GAME_BEDWARS("SCOREBOARDS.PARTY.BEDWARS", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bYour Bed: &a<bed>",
            "&bOpp Bed: &c<opponent-bed>",
            " ",
            "&bserver.net",
            "&7&m--------------------"),

    PARTY_IN_GAME_BEDWARS_TEAM("SCOREBOARDS.PARTY.BEDWARS-TEAM", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bYour Team: &a<alive>&f/&a<max>",
            "&bOpponents: &c<alive-opponent>&f/&c<max-opponent>",
            "&bBed: &a<bed>&7/&c<opponent-bed>",
            " ",
            "&bserver.net",
            "&7&m--------------------"),

    PARTY_ENDED("SCOREBOARDS.PARTY.ENDED", DataType.STRING_LIST,
            "&7&m--------------------",
            "&fMatch Ended",
            " ",
            "&bserver.net",
